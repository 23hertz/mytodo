...
spl_autoload_register(function($className){
    ...
    if($obj->reg_User($fname,$lname,$address)){
        echo "successful";
      ...
      <div class="row">
        <div class="small-8">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="submit" id="right-label" name="register" value="Register" style="background: #0078A0; border: none; color: #fff; font-family: 'Helvetica Neue', sans-serif; font-size: 1em; padding: 10px;">
